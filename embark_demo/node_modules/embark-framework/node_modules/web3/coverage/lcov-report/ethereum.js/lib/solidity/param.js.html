...
<html lang="en">
<head>
    <title>Code coverage report for ethereum.js/lib/solidity/param.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ethereum.js/lib/solidity/param.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">ethereum.js/lib/solidity/</a> &#187; param.js</div>
</div>
<div class="body">
...
var SolidityParam = function (value, offset) {
    this.value = value || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
...
SolidityParam.prototype.offsetAsBytes = function () {
    return !this.isDynamic() ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: utils.padLeft(utils.toTwosComplement(this.offset).toString(16), 64);
};
&nbsp;
/**
